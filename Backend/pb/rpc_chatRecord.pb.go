...
func (x *CreateChatRecordRequest) GetMedia() []byte {
	if x != nil {
		return x.Media
	}
	return nil
...
func (x *GetLastMsgResponse) GetMedia() []byte {
	if x != nil {
		return x.Media
	}
	return nil
...
func (x *UpdateChatRecordRequest) GetMedia() []byte {
	if x != nil {
		return x.Media
	}
	return nil
...
var file_rpc_chatRecord_proto_rawDesc = []byte{
	...
	0x14, 0x0a, 0x05, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05,
	...
	0x12, 0x14, 0x0a, 0x05, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52,
	...
	0x05, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x4d, 0x65,
