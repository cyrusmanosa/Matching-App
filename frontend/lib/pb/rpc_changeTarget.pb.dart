...
import 'changeTarget.pb.dart' as $22;
...
class CreateChangeTargetResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateChangeTargetResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'), createEmptyInstance: create)
    ..aOM<$22.ChangeTarget>(1, _omitFieldNames ? '' : 'ct', subBuilder: $22.ChangeTarget.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $22.ChangeTarget get ct => $_getN(0);
  @$pb.TagNumber(1)
  set ct($22.ChangeTarget v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCt() => $_has(0);
  @$pb.TagNumber(1)
  void clearCt() => clearField(1);
  @$pb.TagNumber(1)
  $22.ChangeTarget ensureCt() => $_ensure(0);
}
