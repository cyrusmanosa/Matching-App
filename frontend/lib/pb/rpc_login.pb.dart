...
class LoginUserResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoginUserResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..aOM<$18.Timestamp>(6, _omitFieldNames ? '' : 'AccessTokenExpiresAt', protoName: 'AccessTokenExpiresAt', subBuilder: $18.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $18.Timestamp get accessTokenExpiresAt => $_getN(2);
  @$pb.TagNumber(6)
  set accessTokenExpiresAt($18.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasAccessTokenExpiresAt() => $_has(2);
  @$pb.TagNumber(6)
  void clearAccessTokenExpiresAt() => clearField(6);
  @$pb.TagNumber(6)
  $18.Timestamp ensureAccessTokenExpiresAt() => $_ensure(2);
}
