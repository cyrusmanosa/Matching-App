...
@$core.Deprecated('Use canChangeDescriptor instead')
const CanChange$json = {
  '1': 'CanChange',
  '2': [
...
/// Descriptor for `CanChange`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List canChangeDescriptor = $convert.base64Decode(
