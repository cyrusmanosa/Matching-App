...
class ChangeTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChangeTarget', package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..aOM<$19.Timestamp>(5, _omitFieldNames ? '' : 'ChangeTime', protoName: 'ChangeTime', subBuilder: $19.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $19.Timestamp get changeTime => $_getN(4);
  @$pb.TagNumber(5)
  set changeTime($19.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasChangeTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearChangeTime() => clearField(5);
  @$pb.TagNumber(5)
  $19.Timestamp ensureChangeTime() => $_ensure(4);
}
