...
class Lover extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Lover', package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..aOM<$12.Timestamp>(16, _omitFieldNames ? '' : 'InfoChangedAt', protoName: 'InfoChangedAt', subBuilder: $12.Timestamp.create)
  ...
  @$pb.TagNumber(16)
  $12.Timestamp get infoChangedAt => $_getN(15);
  @$pb.TagNumber(16)
  set infoChangedAt($12.Timestamp v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasInfoChangedAt() => $_has(15);
  @$pb.TagNumber(16)
  void clearInfoChangedAt() => clearField(16);
  @$pb.TagNumber(16)
  $12.Timestamp ensureInfoChangedAt() => $_ensure(15);
}
