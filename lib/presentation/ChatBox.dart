...
class ChatBox extends StatelessWidget {
  ...
  PreferredSizeWidget _buildHeader(BuildContext context) {
    return CustomAppBar(
      ...
      centerTitle: true,
      title: AppbarTitle(text: "ターゲット名前", margin: EdgeInsets.only(top: 60, bottom: 10)),
      actions: [AppbarTrailingImage(imagePath: ImageConstant.imgMenu, margin: EdgeInsets.fromLTRB(35, 65, 35, 20))],
